                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <img class="img-fluid rounded mb-5" src="assets/${tampil[i].img}" alt="..." />
...
function insertNewRecord(data) {
    ...
    cell4.innerHTML = `<button class="btn btn-secondary"  id="Bayar" type="button" onClick="bayar(this)">Bayar</button>
